jQuery(document).ready(function ($) {
    ...
    _CaptionTransitions["L"] = { $Duration: 900, x: 0.6, $Easing: { $Left: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
            ...
            _CaptionTransitions["T"] = { $Duration: 900, y: -0.2, $Easing: { $Top: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
            ...
            _CaptionTransitions["CLIP|LR"] = { $Duration: 900, $Clip: 1, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic }, $Opacity: 1.5 };
            _CaptionTransitions["MCLIP|L"] = { $Duration: 900, $Clip: 1, $Move: true, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic} };
            _CaptionTransitions["MCLIP|R"] = { $Duration: 900, $Clip: 2, $Move: true, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic} };

    var _SlideshowTransitions = [{$Duration:1400,$Opacity:2,$Brother:{$Duration:1000,$Opacity:2}}];
    ...
    var jssor_slider_banner = new $JssorSlider$("banner-content", options);
