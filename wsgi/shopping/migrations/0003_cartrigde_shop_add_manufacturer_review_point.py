...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_product', u'manufacturer',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.review_point'
        db.add_column(u'shop_product', u'review_point',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shop_product', u'manufacturer')

        # Deleting field 'Product.review_point'
        db.delete_column(u'shop_product', u'review_point')
    ...
    models = {
        ...
        u'shop.product': {
            ...
            'in_sitemap': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'keywords_string': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            u'manufacturer': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            u'review_point': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
