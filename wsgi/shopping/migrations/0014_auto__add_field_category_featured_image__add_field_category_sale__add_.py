...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shopping_category', 'featured_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.sale'
        db.add_column(u'shopping_category', 'sale',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shopping.Sale'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.price_min'
        db.add_column(u'shopping_category', 'price_min',
                      self.gf('shopping.fields.MoneyField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Category.price_max'
        db.add_column(u'shopping_category', 'price_max',
                      self.gf('shopping.fields.MoneyField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Category.combined'
        db.add_column(u'shopping_category', 'combined',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shopping_category', 'featured_image')

        # Deleting field 'Category.sale'
        db.delete_column(u'shopping_category', 'sale_id')

        # Deleting field 'Category.price_min'
        db.delete_column(u'shopping_category', 'price_min')

        # Deleting field 'Category.price_max'
        db.delete_column(u'shopping_category', 'price_max')

        # Deleting field 'Category.combined'
        db.delete_column(u'shopping_category', 'combined')
