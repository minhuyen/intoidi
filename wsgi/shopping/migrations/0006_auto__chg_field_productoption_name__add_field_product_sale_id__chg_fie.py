...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shopping_productoption', 'name', self.gf('shopping.fields.OptionField')(max_length=50, null=True))
        # Adding field 'Product.sale_id'
        db.add_column(u'shopping_product', 'sale_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'Product.unit_price'
        db.alter_column(u'shopping_product', 'unit_price', self.gf('shopping.fields.MoneyField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Product.sku'
        db.alter_column(u'shopping_product', 'sku', self.gf('shopping.fields.SKUField')(max_length=20, unique=True, null=True))

        # Changing field 'Product.sale_price'
        db.alter_column(u'shopping_product', 'sale_price', self.gf('shopping.fields.MoneyField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ProductOption.name'
        db.alter_column(u'shopping_productoption', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
        # Deleting field 'Product.sale_id'
        db.delete_column(u'shopping_product', 'sale_id')


        # Changing field 'Product.unit_price'
        db.alter_column(u'shopping_product', 'unit_price', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Product.sku'
        db.alter_column(u'shopping_product', 'sku', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20, null=True))

        # Changing field 'Product.sale_price'
        db.alter_column(u'shopping_product', 'sale_price', self.gf('django.db.models.fields.FloatField')(default=0))
