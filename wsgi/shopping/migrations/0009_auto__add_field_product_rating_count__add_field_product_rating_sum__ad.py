...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shopping_product', u'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Product.rating_sum'
        db.add_column(u'shopping_product', u'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Product.rating_average'
        db.add_column(u'shopping_product', u'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Product.image'
        db.add_column(u'shopping_product', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shopping_product', u'rating_count')

        # Deleting field 'Product.rating_sum'
        db.delete_column(u'shopping_product', u'rating_sum')

        # Deleting field 'Product.rating_average'
        db.delete_column(u'shopping_product', u'rating_average')

        # Deleting field 'Product.image'
        db.delete_column(u'shopping_product', 'image')
