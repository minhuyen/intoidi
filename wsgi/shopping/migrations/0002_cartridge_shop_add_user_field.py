...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_product', u'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.CustomUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.user'
        db.delete_column(u'shop_product', u'user_id')
    ...
    models = {
        ...
        u'shop.product': {
            ...
            u'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.CustomUser']", 'null': 'True', 'blank': 'True'})
        },
